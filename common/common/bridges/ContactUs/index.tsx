...
function ContactUs({ onSuccessSubmit }: Props) {
  ...
  const schema = yup.object().shape(
    {
      company: yup.string().required(t('about-27')),
      phoneNumber: yup
        .string()
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <Typography variant="button">{t('about-26')}</Typography>
          </SubmitButton>
        </Box>
      </Box>
    </Box>
